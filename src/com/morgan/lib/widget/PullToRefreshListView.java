...
public class PullToRefreshListView extends ListView implements OnScrollListener {
    ...
    private final static int STATE_PULL_TO_REFRESH = 0X1001;
    // State of Can release to refresh
    private final static int STATE_RELEASE_TO_REFRESH = 0X1002;
    // State of refreshing
    private final static int STATE_REFRESHING = 0X1003;
    // State of Finish refresh
    private final static int STATE_DONE = 0X1004;
    ...
    public PullToRefreshListView(Context context, AttributeSet attrs) {
        ...
        mNoDataMessage = ta.getString(R.styleable.PullToRefreshListView_noDataMsg);
        ta.recycle();
    ...
    private void init() {
        ...
        mFooterView = (LinearLayout) mInflater.inflate(R.layout.lib_pull_to_refresh_listview_footer, null);
        ...
        mHeaderView = (LinearLayout) mInflater.inflate(R.layout.lib_pull_to_refresh_listview_header, null);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_UP:
            if (mIsRecored) {
                if (mStatus == STATE_PULL_TO_REFRESH) {
                    mStatus = STATE_DONE;
                    changeHeaderViewByState();
                } else if (mStatus == STATE_RELEASE_TO_REFRESH) {
        ...
        case MotionEvent.ACTION_MOVE:
            ...
            if (mIsRecored && mStatus != STATE_REFRESHING) {
                ...
                if (mStatus == STATE_RELEASE_TO_REFRESH || mStatus == STATE_PULL_TO_REFRESH
    ...
    private void changeHeaderViewByState() {
        ...
        case STATE_DONE:
            mIsBack = false;
            mHeaderRefreshArrow.setImageResource(R.drawable.lib_ic_refresh_arrow);
            mHeaderProgressBar.setVisibility(View.GONE);
            mHeaderStatus.setText(R.string.pull_to_refresh);
            mRefreshHeaderView.setPadding(mRefreshHeaderView.getPaddingLeft(), -1 * mRefreshHeaderHeight,
                    mRefreshHeaderView.getPaddingRight(), mRefreshHeaderView.getPaddingBottom());
